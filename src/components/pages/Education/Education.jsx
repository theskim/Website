...
const Description = () => {
  return (
    <>
      <img src={UofTLogo} loading="lazy" alt="" />
      <br />
      <p>
      ...
      <h2>2021 - Present (PEY CO-OP)</h2>
      <p>
        <Icon icon="mdi:certificate" width="1.3rem" />
        &nbsp;Minor in <b>Artificial Intelligence Engineering</b>
        <br />
        <b>
          <Icon icon="tabler:award" width="1.3rem" />
          &nbsp;NSERC
        </b>{" "}
        Undergraduate Student Research Award
        <br />
        <b>
          <Icon icon="mdi:award" width="1.3rem" />
          &nbsp;Dean&apos;s List
        </b>{" "}
        in All Semesters
        <br />
        <Icon icon="carbon:skill-level-basic" width="1.3rem" />
        &nbsp;Courses focused in <b>ML/AI</b>, <b>Software Engineering</b>, and{" "}
