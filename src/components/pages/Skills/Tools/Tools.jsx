...
const Tools = () => {
    const section = [
        ...
        {location: <Icon icon="mdi:language-typescript" width="min(20vw, 8rem)" cursor="pointer" margin="min(19vw, 3rem)" color="rgb(91, 58, 255)"  />, name: "TypeScript (ES6+)"},
        ...
        {location: <Icon icon="simple-icons:linux" width="min(20vw, 8rem)" cursor="pointer" margin="min(19vw, 3rem)" color="rgb(91, 58, 255)" />, name: "Linux"},
