...
const Tools = () => {
    const section = [
        ...
        {location:<Icon icon="simple-icons:tensorflow" width="min(15vw, 6rem)" cursor="pointer" margin="min(15vw, 2rem)" color="rgb(91, 58, 255)" />, name: "TensorFlow"},
        ...
        {location: <Icon icon="devicon-plain:junit" width="min(15vw, 6rem)" cursor="pointer" margin="min(15vw, 2rem)" color="rgb(91, 58, 255)" />, name: "JUnit"},
