  ...
  return (
    <div className="about-me-description">
      ...
      <p>
        ...
        Toronto, also pursuing a minor in Artificial Intelligence. <br />
        <br />
        ...
        <br />
        Aside from work, I am a huge football/soccer (⚽) fan, I am a supporter
        of Tottenham Hotspur FC, Toronto FC, and Canada MNT.
        <br />
        <br />
